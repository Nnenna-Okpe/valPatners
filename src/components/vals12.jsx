...
import "./vals12.css";
import myImage1 from "../assets/images/1771016796845.jpg";
import myImage2 from "../assets/images/1771016796865.jpg";
import myImage3 from "../assets/images/1771016796855.jpg";
  ...
  return (
    <div ref={containerRef} className="relative w-full">
        ...
        <div className="max-w-5xl w-full">
          <div className="text-center mb-16">
            ...
            <p className="text-rose-400 font-romantic text-2xl">
              A few snapshots of the woman I love
            </p>
          </div>
      ...
      <section className="h-screen w-full flex flex-col items-center justify-center text-center px-6 relative z-10 bg-[#1a0d0d]/5">
        ...
        <p className="mt-2 font-romantic text-4xl text-rose-700">Your Love</p>
