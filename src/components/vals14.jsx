...
import "./vals14.css";
import img1 from "../assets/images/1771021819433.jpg";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center text-left">
              <div className="space-y-6">
                ...
                <p className="text-[#f5e6be]/80 leading-relaxed italic">
                  These are not words written by chance — they are the truth my
                  heart already knows about you {userName}.
                </p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-12">
              ...
              <p className="text-[#f5e6be]/80 italic max-w-lg mx-auto">
                Here are moments that shaped our story — glowing like embers in
                the dark.
              </p>
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <p className="text-xl text-[#f5e6be] italic max-w-md mx-auto">
                  {userName}, beneath this velvet midnight, I have one question
                  for you...
                </p>
